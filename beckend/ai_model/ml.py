...
def load_rbs_model():
    ...
    if rbs_model_instance is None:
        ...
        rbs_model_instance.load_model("C:\\mobilis-sites-management\\beck-end\\beckend\\ai_model\\models\\xgb_rbs_model.json")
...
def load_freq_model():
    ...
    if freq_model_instance is None:
        ...
        freq_model_instance.load_model("C:\\mobilis-sites-management\\beck-end\\beckend\\ai_model\\models\\xgb_freq_model.json")
    return freq_model_instance

def load_rl_model():
    global rl_model
    if rl_model is None:
        rl_model = PPO.load("C:\\mobilis-sites-management\\beck-end\\beckend\\ai_model\\models\\dc_cooling_ppo.zip")  
        # Update class/path if needed
    return rl_model
